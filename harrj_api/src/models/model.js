...
exports.CheckUnique = async(field,table,val,res,id_field='',id='',id_field1='',id1='') => {
return new Promise( function(resolve , reject ){
	let where ='';
	...
	if(id1!=undefined && id1!='' && id_field1!=undefined && id_field1!='')
		{
			where=' AND '+id_field1+'=?';
			data.push(id1);
		}
...
exports.CheckUniqueTwoFields = async(field,field1,table,val,val1,res,id_field='',id='',id_field1='',id1='') => {
	return new Promise( function(resolve , reject ){
		let where ='';
		let data=[ACTIVE_STATUS,val,val1];
		...
		let str=' AND ('+field+'=?'+' OR '+field1+'=?)';
		let query = "SELECT `"+field+"`, `"+field1+"` FROM "+table+" WHERE status=?"+str+where+"";
		console.log(query);
		sql.query(query,data,(err, result,cache) => {
			if(err) 
			{
...
exports.CheckUniqueWithRef = async(field,table,val,res,id_field='',id='',id_field1='',id1='',ref_feild='',ref_id='') => {
return new Promise( function(resolve , reject ){
	let where ='';
	let data=[ACTIVE_STATUS,val];
...
exports.CheckUniqueWithRefWithTwoFields = async(field,field1,table,val,val1,res,id_field='',id='',id_field1='',id1='',ref_feild='',ref_id='') => {
	return new Promise( function(resolve , reject ){
		let where ='';
		let data=[ACTIVE_STATUS,val,val1];
...
exports.CheckUniqueWithTwoRef = async(field,table,val,res,id_field='',id='',id_field1='',id1='',ref1_feild='',ref1_id='',ref2_feild='',ref2_id='') => {
	return new Promise( function(resolve , reject ){
		let where ='';
		let data=[ACTIVE_STATUS,val];
	...
	exports.CheckUniqueWithTwoRefWithTwoFields = async(field,field1,table,val,val1,res,id_field='',id='',id_field1='',id1='',ref1_feild='',ref1_id='',ref2_feild='',ref2_id='') => {
		return new Promise( function(resolve , reject ){
			let where ='';
			let data=[ACTIVE_STATUS,val,val1];
	...
	exports.CheckUniqueWithThreeRef = async(field,table,val,res,id_field='',id='',id_field1='',id1='',ref1_feild='',ref1_id='',ref2_feild='',ref2_id='',ref3_feild='',ref3_id='') => {
		return new Promise( function(resolve , reject ){
			let where ='';
			let data=[ACTIVE_STATUS,val];
		...
		exports.CheckUniqueWithThreeRefWithTwoFields = async(field,field1,table,val,val1,res,id_field='',id='',id_field1='',id1='',ref1_feild='',ref1_id='',ref2_feild='',ref2_id='',ref3_feild='',ref3_id='') => {
			return new Promise( function(resolve , reject ){
				let where ='';
				let data=[ACTIVE_STATUS,val,val1];
